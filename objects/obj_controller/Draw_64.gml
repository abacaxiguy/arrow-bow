...
draw_text_color(global.cameraWidth/3, 30, "Arrow Bow", c_red, c_yellow, c_lime, c_red, 1)
draw_text_color(global.cameraWidth/1.2, 50, "Score: " + string(score), c_yellow, c_yellow, c_yellow, c_yellow, 1)
